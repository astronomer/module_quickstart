...
- [ ]  Create a storage container named `covid-data` which will be used by the Example DAG
    ...
    ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2059.png)
...
- [ ]  Obtain your Storage Account’s **Key:**
    ...
    - To illustrate where the credentials can be found:
        ...
        ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2060.png)
...
- [ ]  Create a ****Microsoft Azure Blob Storage Connection**** named `wasb_default` in the Airflow UI:
    - Fields to populate:
        ...
        - `Blob Storage Login` - This is the name of your storage account (found in the top-left corner of the Storage Account’s page):
            ...
            ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2061.png)
        ...
        - To summarize, these are the 4 fields to populate:
            ...
            ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2062.png)
...
- [ ]  Confirm via Azure Blob Storage console that the blobs were created in the appropriate container and directories:
    ...
    ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2063.png)
