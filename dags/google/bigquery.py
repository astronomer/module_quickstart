...
- [ ]  [Create a new Service Account](https://console.cloud.google.com/iam-admin/serviceaccounts/create) (or retrieve the JSON for an existing Service Account with Permission)
    ...
    ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2064.png)

- [ ]  Add Roles to your Service Account - `BigQuery User` , and `BigQuery Data Editor` then click through to `Done`

    ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2065.png)

- [ ]  Navigate to your new Service Account, then `Keys` , then `Add Key` , then download a Service Account JSON Key File

    ![Untitled](ADE%20Modules%20&%20Knowledge%20Base%20%5BDEPRECATING%5D%20395fc8c6c2e74faaa859c326369eeb50/Untitled%2066.png)
...
- Reference
    ...
    POC for OSS BigQuery components 👇

    [cs-tutorial-bigquery.zip](Customer%20Success%205fa4468af19c42298174b015c97bfb57/Astro%20Data%20Engineering%20e60033fca30c4e618d3b8dc51b2ee8ab/Resource%20Glossary%20a45cce63a5c7468b922454fd937d4a5c/cs-tutorial-bigquery.zip)
